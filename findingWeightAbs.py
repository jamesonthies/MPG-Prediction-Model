...
possibilities = find_range_adjustment_results_abs(data, mpg_equations, abs_corr_vector)

plt.scatter([i for i in range(-100, 100)], possibilities, label='weight adjustment values', color='k', s=25, marker="o")
plt.xlabel('Adjustment Weight')
plt.ylabel('Sum of Absolute Value of Errors')
plt.show()
